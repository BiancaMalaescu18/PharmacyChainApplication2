...
public class ButonFiltrarePret implements Command{

    private String search;

    public ButonFiltrarePret(VMAngajat vm, String search){
        this.search = search;
    }
    ...
    public void execute() {
        ...
        try {
            ...
            produse.getProduse().removeIf(p -> p.getPret() != (Double.parseDouble(search)));
